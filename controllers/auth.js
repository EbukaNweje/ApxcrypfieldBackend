  ...
  try{
    ...
    html: `
     ...
     <p>If you didn't initiate this action or if you think you received this email by mistake, please contact <br>
      apexcryptfield@gmail.com@gmail.com
     </p>
        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h4 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">You have successfully logged in to,<br/> <span style=" font-weight: 500; color:#EABD4E; margin-top:-10px; font-size: 20px;"> Apxcrypfield/span></h4>
